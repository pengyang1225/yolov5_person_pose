...
class Detect(nn.Module):
    ...
    def __init__(self, nc=80, anchors=(), ch=()):  # detection layer
        ...
        self.no = nc + 5 + 24 +12 # number of outputs per anchor
       ...
       # self.training |= self.export
        ...
        for i in range(self.nl):
            ...
            if not self.training:  # inference
                ...
                class_range = list(range(5)) + list(range(29,29+self.nc))
                ...
                y[..., 15:17] = y[..., 15:17] * self.anchor_grid[i] + self.grid[i].to(x[i].device) * self.stride[i]  # landmark x6 y6
                y[..., 17:19] = y[..., 17:19] * self.anchor_grid[i] + self.grid[i].to(x[i].device) * self.stride[
                    i]  # landmark x6 y7
                y[..., 19:21] = y[..., 19:21] * self.anchor_grid[i] + self.grid[i].to(x[i].device) * self.stride[
                    i]  # landmark x6 y8
                y[..., 21:23] = y[...,  21:23] * self.anchor_grid[i] + self.grid[i].to(x[i].device) * self.stride[
                    i]  # landmark x6 y9
                y[..., 23:25] = y[..., 23:25] * self.anchor_grid[i] + self.grid[i].to(x[i].device) * self.stride[
                    i]  # landmark x6 y10
                y[..., 25:27] = y[..., 25:27] * self.anchor_grid[i] + self.grid[i].to(x[i].device) * self.stride[
                    i]  # landmark x6 y11
                y[..., 27:29] = y[..., 27:29] * self.anchor_grid[i] + self.grid[i].to(x[i].device) * self.stride[
                    i]  # landmark x6 y12
